...
ALTER TABLE `issued_books`
ADD CONSTRAINT `fk_issued_books_book_no`
...
ALTER TABLE `issued_books`
ADD CONSTRAINT `fk_issued_books_student_id`
FOREIGN KEY (`student_id`) REFERENCES `users`(`id`)
ON DELETE RESTRICT;

-- Update issued_books table to reference authors
ALTER TABLE `issued_books`
ADD CONSTRAINT `fk_author_id` FOREIGN KEY (`book_author`) REFERENCES `authors`(`author_id`)
ON DELETE RESTRICT;

-- If you don't already have a constraint for books referencing authors
ALTER TABLE `books`
ADD CONSTRAINT `fk_books_author` FOREIGN KEY (`book_author`) REFERENCES `authors`(`author_id`)
ON DELETE CASCADE;
